...
FragmentTransaction ft;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (pro.equals("jacket")){
            ...
            ArrayList<ClassShowPrice> data=new ArrayList<>();
            data.add(new ClassShowPrice("male2",R.drawable.male,"300","shoe","female"));
            data.add(new ClassShowPrice("female",R.drawable.female,"400","shoe","female"));
            data.add(new ClassShowPrice("male",R.drawable.male,"500","shoe","female"));
            data.add(new ClassShowPrice("female",R.drawable.female,"600","shoe","female"));
            RecyclerView rv=findViewById(R.id.recy1);
            Adapterfinaluser ad=new Adapterfinaluser(data);
            rv.setAdapter(ad);
            rv.hasFixedSize();
            ...
            ArrayList<ClassShowPrice> data=new ArrayList<>();
            data.add(new ClassShowPrice("male4",R.drawable.male,"300","hat","female"));
            data.add(new ClassShowPrice("female",R.drawable.female,"400","hat","female"));
            data.add(new ClassShowPrice("male",R.drawable.male,"500","hat","female"));
            data.add(new ClassShowPrice("female",R.drawable.female,"600","hat","female"));
            RecyclerView rv=findViewById(R.id.recy1);
            Adapterfinaluser ad=new Adapterfinaluser(data);
            rv.setAdapter(ad);
            rv.hasFixedSize();
