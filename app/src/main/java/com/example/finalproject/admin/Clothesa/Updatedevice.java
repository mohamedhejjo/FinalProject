...
public class Updatedevice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data.add(new ClassShowPrice("male",R.drawable.male,"100","ee"));
        data.add(new ClassShowPrice("female",R.drawable.female,"200","ee"));
        data.add(new ClassShowPrice("male",R.drawable.male,"500","ee"));
        data.add(new ClassShowPrice("female",R.drawable.female,"800","ee"));
